...
def test_event_stats_creation():
    ...
    sim = Sim(scenario="simple", analyzers=[analyzer])
...
def test_multi_analyzer_integration():
    ...
    # Test integration with Rotasim using simple scenario
    sim = Sim(scenario="simple", analyzers=analyzers, n_agents=500)
...
def test_analyzer_interfaces():
    ...
    analyzers = [("StrainStats", StrainStats()), ("EventStats", EventStats()), ("AgeStats", AgeStats())]
