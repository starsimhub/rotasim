...
def main():
    ...
    sim2 = Sim(initial_strains=[(1, 8), (2, 4), (3, 6)], fitness_scenario="high_diversity", base_beta=0.15)
    ...
    sim3 = Sim(initial_strains=[(1, 8), (2, 4)], connectors=[custom_immunity])
    ...
    sim4 = Sim(initial_strains=[(1, 8), (2, 4)], connectors=[])  # No connectors
