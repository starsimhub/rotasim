...
class MultiList(ss.Arr):
    '''
        A class for storing agent States having lists of values. This is useful when the number of values per agent is
        dynamic, such as infection history or immunities an agent has.
    '''
