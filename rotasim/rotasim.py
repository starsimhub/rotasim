...
class Sim(ss.Sim):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        diseases = self._create_strain_diseases(
            final_scenario,
            base_beta,
        ...
        if "connectors" not in kwargs:
            default_connectors = [RotaImmunityConnector(), RotaReassortmentConnector()]
    ...
    def get_strain_summary(self):
        ...
        if not hasattr(self, "diseases"):
            ...
            expected_combinations = generate_gp_reassortments(
                initial_strains, use_preferred_partners=self._use_preferred_partners
            )
