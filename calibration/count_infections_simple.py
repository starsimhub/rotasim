"""
Simple infection count diagnostic - Run ONE simulation and examine infection counts
Does NOT import from calibrate_uk to avoid triggering calibration
"""
import sys
...
print("=" * 80)
print("SIMPLE INFECTION COUNT DIAGNOSTIC")
print("=" * 80)
