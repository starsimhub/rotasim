"""
Quick test of Trial 19 parameters with SMALLER population (10k agents)
"""
import sys
...
print("="*60)
print("Testing Trial 19 Parameters - SMALL POPULATION (10k)")
print("="*60)
print("\nParameters:")
for k, v in TRIAL_19_PARAMS.items():
    print(f"  {k}: {v:.6f}")
print("\nPopulation: 10,000 agents (10x smaller)")
