...
def compute_gof(actual, predicted, normalize=True, use_frac=False, use_squared=False, eps=1e-9):
    """
...
class Calibration(sc.prettyobj):
    ...
    """
    def __init__(self, data, calib_pars, n_trials=20, n_workers=None, total_trials=None, 
                 reseed=True, die=False, debug=False, verbose=True):
        ...
        kw = dict(n_trials=int(n_trials), n_workers=int(n_workers), debug=debug, name='rota', db_name=db_name,
