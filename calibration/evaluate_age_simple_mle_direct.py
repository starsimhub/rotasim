"""Evaluate age_and_infection_simple model at MLE parameters (direct approach)"""
import sys
...
analyzer.reporting_rate = MLE_PARAMS['reporting_rate']
...
# Set beta parameters directly (following evaluate_age_simple_fixed_severity.py approach)
sim.pars.diseases[0].pars.beta = MLE_PARAMS['base_beta'] * 0.16 / 3.0
sim.pars.diseases[0].pars.beta0 = MLE_PARAMS['beta0']
sim.pars.diseases[0].pars.beta1 = MLE_PARAMS['beta1']
sim.pars.diseases[0].pars.beta2 = MLE_PARAMS['beta2']
...
results_dict = {
    ...
    'age_distribution': {
        ...
        'fitted': [age_distribution_props[ag] if ag in age_distribution_props.index else 0.0 for ag in age_groups],
        'labels': age_labels
    }
}
