"""Exp 65, single-seed worker -- Bangladesh infnum ODE direct-fit. Identical
method to exp64 (Bangladesh age_binned) and India's exp59, differing only in
symptom-model structure: p_symp keyed by infection order (cascading ratios,
same convention as sus_r2/sus_r3) instead of age bin.
"""
...
print(f"[{SITE}, infnum] Targets: IR={IR_DATA}, repeat={REPEAT_OBS}/{REPEAT_N}, n_firstinf={len(FIRSTINF)}, "
