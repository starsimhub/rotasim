"""Exp 64 orchestrator -- runs `run_one_seed.py <seed>` as a fresh OS process
per seed (sequentially; each already saturates all cores via workers=-1),
same pattern as exp58/59/60/61."""
...
SEEDS = [20260817, 1, 2, 3, 4, 5]  # same seeds as India's exp58/59, for a like-for-like comparison
