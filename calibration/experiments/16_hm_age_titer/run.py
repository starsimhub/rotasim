"""Exp 16 reproduction — HM posterior (NROY) for age+titer under the cohort observation.
Driver is the shared calibration/hm_calibrate.py (--model age). Run on a 120-core box in
