"""
Test calibration with ALL age distribution fixes:
...
Strategy:
- Use birth_rate=30, death_rate=10, emigration=10/1000 adults
- This produces age distribution [2.7%, 3.1%, 8.6%, 85.5%]
- Very close to Matlab target [2.5%, 2.5%, 7.5%, 87.5%]
- Death rate of 10/1000 is realistic (compared to previous 20/1000)
- process_incidence.py now calculates actual age fractions from simulation data
- This should eliminate the artificial bias that was inflating adult case proportions
"""
import sys
sys.path.insert(0, '.')
