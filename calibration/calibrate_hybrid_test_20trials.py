"""
Hybrid calibration TEST: 20 trials with new GOF metric
...
print("=" * 80)
print("HYBRID CALIBRATION TEST: 20 Trials with New GOF Metric")
print("=" * 80)
print("\nNew GOF Formula:")
...
class HybridCalibration(ss.Calibration):
    ...
    def calibrate(self):
        ...
        study = optuna.create_study(
            study_name='rota_hybrid_test',
            direction='minimize',
            storage='sqlite:///rota_hybrid_test.db',
            load_if_exists=True,
...
# Run calibration
print("\n" + "=" * 80)
print("Starting calibration with 20 trials...")
print("=" * 80)
